...
class BrainTumorv3(nn.Module):
    def __init__(self, num_classes=4, pretrained_weights="yolov8l.pt"):
        ...
        self.attention_1 = AttentionBlock(dim=256)
        self.attention_2 = AttentionBlock(dim=512)
        self.attention_3 = AttentionBlock(dim=512)
    ...
    def forward(self, x):
        ...
        # --- Head ---
        a1 = self.attention_1(p2)
        a2 = self.attention_2(n3)
        a3 = self.attention_3(n4)

        y = self.head([a1, a2, a3])
        return y
