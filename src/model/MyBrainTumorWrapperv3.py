...
from src.model.BrainTumorWrapperv3 import BrainTumorWrapperv3
from ultralytics.utils.loss import VarifocalLoss
from src.config import *
from src.model.LossWrapper import *
class MyBrainTumorWrapperv3:
    def __init__(self, model, device=None, CKPT_PATH=None, img_size=img_size, num_classes=4):
        self.wrapper = BrainTumorWrapperv3(model = model, device=device, CKPT_PATH=CKPT_PATH, num_classes = num_classes, img_size = img_size)
