...
from src.model.BrainTumorWrapperv2 import BrainTumorWrapperv2
from ultralytics.utils.loss import VarifocalLoss
from src.config import *
from src.model.LossWrapper import *
class MyBrainTumorWrapperv2:
    def __init__(self, model, device=None, CKPT_PATH=None, img_size=img_size, num_classes=4):
        self.wrapper = BrainTumorWrapperv2(model = model, device=device, CKPT_PATH=CKPT_PATH, num_classes = num_classes, img_size = img_size)
