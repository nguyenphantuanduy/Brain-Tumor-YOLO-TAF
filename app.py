...
class BrainTumorApp:
    def __init__(self, root):
        ...
        bg_img = Image.open(resource_path("BrainTumorBackground.jpg")).resize((1100, 600))
        ...
        self.left_frame.place(x=80, y=100, width=400, height=400)
        self.right_frame = tk.Frame(root, bg="#ffffff", highlightbackground="black", highlightthickness=1)
        self.right_frame.place(x=620, y=100, width=400, height=400)
    ...
    def predict(self):
        if not self.image_path:
            self.status_label.config(text="⚠️ Hãy chọn ảnh trước khi dự đoán.")
            return
